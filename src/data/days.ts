...
export const days: Day[] = [
  ...
  },
  {
    ...
    townsCount: 2,
    narrative: [
      { type: 'text', content: 'A shorter day. The trail out of Arzúa drops back into eucalyptus forest pretty quickly and stays there for most of the morning. The last hundred kilometers of the Camino Francés is the most walked section of any Camino route, because it\'s the minimum distance you need to complete to get the Compostela certificate at the end.' },
      { type: 'text', content: 'Partway through we stopped at a bar for a few beers. While we were there a bunch of Spanish locals were dancing and singing. Really good vibes. The kind of stop where you walk in for one beer and stay for three.' },
  ...
  },
  {
    ...
    narrative: [
      ...
      { type: 'text', content: 'Along the way I finally got my concha, the scallop shell that pilgrims attach to their packs. It\'s the symbol of the Camino, you see them on every albergue and every trail marker, and most pilgrims pick one up at the start. I procrastinated but wanted it by the end.' },
  ...
  },
  {
    ...
    narrative: [
      ...
      { type: 'text', content: 'Spent the rest of the day exploring Santiago. Wandered through some of the parks, which were beautiful with the weather. Parque da Alameda was full of locals on a Saturday afternoon, kids playing, old couples walking arm in arm.' },
